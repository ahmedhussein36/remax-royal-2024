            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
                    <div className="flex items-center lg:mb-0 mb-10">
                        <div>
                            <h4 className="text-indigo-600 text-3xl font-bold leading-6 mb-4 lg:text-right text-center">
                                تواصل معنا
                            </h4>
                            <h2 className="text-gray-900 font-manrope text-lg font-medium leading-10 mb-9 lg:text-right text-center">
                                إذا كان لديك اي استفسار او اقتراح فلاتردد فى
                                الاتصال بنا
                            </h2>
                            <form>
                                <input
                                    type="text"
                                    className="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8"
                                    placeholder="الاسم"
                                />
                                <input
                                    type="email"
                                ...
                                <textarea
                                    id="text"
                                    className="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none px-4 py-4 mb-8"
                        ...
                        <div>
                            <div className=" flex flex-col lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                                <div className="flex flex-row-reverse items-center mb-6">
                                    ...
                                    <h5 className="text-black text-left text-base font-normal leading-6 ml-5">
                                        1500366642 <span> 20+ </span>
                                    </h5>
                                </div>
                                <div className="flex flex-row-reverse items-center mb-6">
                                    <svg
                                ...
                                <div className="flex flex-row-reverse items-center mb-6">
                                    ...
                                    <h5 className="text-black text-left text-base font-normal leading-6 ml-5">
                                        South Teseen Street, in front of
                                        Eastown, Fifth Settlement, New Cairo
                                    </h5>
                                </div>
...
//                         >
//                             <strong>admin@remaxroyal.com</strong>
//                         </a>
//                     </li>
//                     <li className="flex items-center gap-3 justify-start flex-row-reverse">
//                         <svg
...
//                     <button
//                         type="button"
//                         className="text-white bg-rose-500 font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-full"
//                     >
//                         <svg
//                             xmlns="http://www.w3.org/2000/svg"
//                             width="16px"
