...
const PrivacyPolicy = () => {
    return (
        <div className="max-w-5xl m-auto my-4 p-8  text-left leading-9">
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Partnership, Address: 18 South Teseen
                            Street, District 8, Fifth Settlement.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Remax Royal,
                            accessible from
                            <a
                                href="https://remaxroyal.net/"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://remaxroyal.net/
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <p>By email: info@remaxroyal.net</p>
                    </li>
                    <li>
                        <p>
                            By visiting this page on our website:
                            <a
                                href="https://remaxroyal.net/contact"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://remaxroyal.net/contact
                            </a>
                        </p>
                    </li>
                </ul>
