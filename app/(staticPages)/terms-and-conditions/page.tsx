            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        to Partnership, 18 South Teseen Street, District 8,
                        Fifth Settlement..
                    </p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        <a
                            href="https://remaxroyal.net/contacts"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://remaxroyal.net/contacts
                        </a>
                    </p>
                </li>
            </ul>
...
export default TermeAndConditions;
